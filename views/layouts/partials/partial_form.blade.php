@extends('twill::layouts.partials.partial_main')
...
@push('extra_css')
    ...
    <style>
    .notif, .a17spinner, .titleEditor__permalink {
...
@section('content')
    <div v-sticky data-sticky-id="navbar" data-sticky-offset="0" data-sticky-topoffset="12" >
        <div class="navbar" style="margin-bottom: 0; margin-top: 15px" data-sticky-top="navbar">
            @php
            ...
            <div class="container">
                <div class="wrapper wrapper--reverse" >
                    <aside class="col col--aside">
                        <div class="publisher" data-sticky-target="publisher" style="display:none;">
                    ...
                    <section class="col col--primary" style="width:100%" data-sticky-top="publisher">
                        @unless($disableContentFieldset)
                            <a17-fieldset :open="{{ request()->input('opened') ? 'true' : 'false' }}" title="{{ $contentFieldsetLabel ?? twillTrans('twill::lang.form.content') }}" id="content">
                                @yield('contentFields')
                            </a17-fieldset>
                        @endunless
